// frontend\src\components\Reports\ReportEmail.jsx

/**
 * קובץ: ReportEmail.jsx
 * ----------------------
 * תיאור:
 * Excel או PDF קומפוננטה לשליחת דוח במייל בפורמט .
 * Excel/PDF כוללת שדה להזנת כתובת דוא"ל, כפתורי שליחה 
 * Popup והצגת הודעות מצב באמצעות .
 *
 * תכונות עיקריות:
 * - לקבלת כותרת, עמודות ושורות מסוננות useReport שימוש ב־  .
 * - ולידציה של כתובת דוא"ל לפני שליחה.
 * - exportעיבוד נתוני שורות לפי עמודות שמוגדרות ל־ .
 * - /reports/send-email - לנתיב axios שליחה לשרת דרך  .
 * - הצגת פופאפ להצלחה/שגיאה.
 */
