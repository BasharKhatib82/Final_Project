 ...
 * רכיב: HomePage
 * -------------------------
 * רכיב המציג את דף הבית של המערכת.
 *
 * מטרת הרכיב:
 * - להציג למשתמש סקירה קצרה על המערכת
 * - להסביר את הפונקציות העיקריות (ניהול פניות, שעות, משימות והרשאות)
 * - לשמש כדף פתיחה ידידותי ומזמין
 *
 * קלט: אין
 * פלט: תוכן סטטי עם כותרות, טקסט ורשימת יתרונות
 */
