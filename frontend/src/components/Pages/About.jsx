 ...
 * רכיב: About
 * -------------------------
 * רכיב תוכן המציג עמוד "אודות המערכת".
 *
 * מטרת הרכיב:
 * - להציג מידע כללי על פרויקט ניהול הלידים
 * - להדגיש את מטרות המערכת ויתרונותיה
 * - לפרט בקצרה את הטכנולוגיות, הפונקציונליות והחזון
 *
 * קלט: אין
 * פלט: תוכן סטטי עם כותרות, טקסט ורשימה.
 */
